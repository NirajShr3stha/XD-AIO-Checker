...
public static class Crypto
    ...
    class Functions
    {
        ...
        public static string UUIDGen() => RandomString(8) + "-" + RandomString(4) + "-4" + RandomString(3) + "-" + RandomString(4) + "-" + RandomString(12);

        public static string RandomString(int length) => new string(Enumerable.Repeat("abcdefhijklmnopqrstuvwxyz0123456789", length).Select(s => s[random.Next(s.Length)]).ToArray());

        public static string RandomDigit(int length) => new string(Enumerable.Repeat("0123456789", length).Select(s => s[random.Next(s.Length)]).ToArray());

        public static string RandomChar(int length) => new string(Enumerable.Repeat("abcdefhijklmnopqrstuvwxyz", length).Select(s => s[random.Next(s.Length)]).ToArray());
        public static string RandomCharUL(int length) => new string(Enumerable.Repeat("abcdefhijklmnopqrstuvwxyzABCDEFGHIJKLMOPQRSTUVWXYZ", length).Select(s => s[random.Next(s.Length)]).ToArray());
